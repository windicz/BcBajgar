...
namespace Microsoft.Azure.Batch.Samples.MultiInstanceTasks
{
    ...
    public class DeployToAzure
    {
        ...
        public static async Task MainAsync()
        {
            ...
            const string appPackageId = "test3";
            ...
            using (BatchClient batchClient = BatchClient.Open(cred))
            {
                ...
                CloudTask multiInstanceTask = new CloudTask(id: taskId,
                    commandline: $"cmd /c mpiexec.exe -c 1 -wdir %AZ_BATCH_TASK_SHARED_DIR% %AZ_BATCH_APP_PACKAGE_{appPackageId.ToUpper()}#{appPackageVersion}%\\MPIParalelApp.exe");
